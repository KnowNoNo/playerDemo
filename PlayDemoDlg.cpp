...
//	ON_NOTIFY(NM_DBLCLK, IDC_LIST2, &CPlayDemoDlg::OnNMDblclkList2)
...
//}
//
//void CPlayDemoDlg::OpenFile(CString csFilePath)
//{
//	/**/
...
//// 检测是否为UTF-8无BOM格式编码
//// src为文本内容，len为文本的长度
//BOOL CPlayDemoDlg::CheckUTF8NoBOM(void* pBuffer, long size)
//{     
//	bool IsUTF8 = true;     
...
//// 从文本中获取编码格式
//// src为文本内容，len为文本的长度
//EncodingType CPlayDemoDlg::GetEncodingTypeFromStr(char *src, long len)
//{
...
//}
//
//void CPlayDemoDlg::ChangePlayButtonUIState(CHoverButton* lpUI[STATE_SIZE] , int nState[9])
//{
...
//}
//
//void CPlayDemoDlg::OnSetIvsEnable(UINT ID)
//{
...
//}
//
//void CPlayDemoDlg::OnNMCustomdrawSliderAudio(NMHDR *pNMHDR, LRESULT *pResult)
//{
